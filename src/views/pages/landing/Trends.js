        ...
        <Grid item xs={12}>
          <Grid container spacing={2.5} direction={{ xs: 'column-reverse', md: 'row' }}>
            <Grid item xs={12} md={6}>
              ...
              >
                Download now to become part of a vibrant community dedicated to driving meaningful change. Together, we can create a brighter future. Your voice matters, join Citizen X today and start making an impact!
              </Typography>
              <Stack direction={{ md: 'row', xs: 'column' }} sx={{ alignItems: 'center', justifyContent: { xs: 'center', md: 'flex-start' } }} spacing={3} pt={3} pb={5}>
