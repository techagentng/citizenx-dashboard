...
import { Stack, Typography, Button, Grid, Container, Tooltip } from '@mui/material';
            ...
            <Grid container>
                <Grid item xs={12} md={6} display="flex" flexDirection="column" justifyContent="center" gap={3}>
                    ...
                    <Stack direction="row" spacing={2}>
                        <Button component={Link} to="/submit-article" variant="contained" color="success" sx={{ textTransform: 'none' }}>
                            Submit Your Article
                        </Button>
                        <Tooltip title="Get in touch with us: admin@citizenx.ng">
